...
@NonNullApi
public class FakeStoreAppProjectDependency extends DelegatingProjectDependency {

    @Inject
    public FakeStoreAppProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
